...
__minpack_attr__
void __minpack_func__(lmdif1bc)(__minpack_decl_fcn_bc_mn__  const int *m, const int *n, real *x, 
	real *fvec, const int* iuser, const real *user,
    const real *tol, int *info, int *iwa, 
	real *wa, const int *lwa)
{
    /* Initialized data */
...
/*     call lmdif. */
    ...
    nprint = 0;
    mp5n = *m + *n * 5;
    __minpack_func__(lmdifbc)(__minpack_param_fcn_bc_mn__ m, n, &x[1], &fvec[1], 
        iuser, user,
